...
public class LivreurHistoryAdapter extends RecyclerView.Adapter<LivreurHistoryAdapter.ViewHolder> {
    private List<DeliveryTask> listData;
    private static RecyclerViewClickListener itemListener;
    public LivreurHistoryAdapter(List<DeliveryTask> listData, RecyclerViewClickListener itemlistener) {
    ...
    public static  class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        public TextView name,time,id_ord,adr_four,adr_client;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View listItem = inflater.inflate(R.layout.list_item_customdone,parent,false);
